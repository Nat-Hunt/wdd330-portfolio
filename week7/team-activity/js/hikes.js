...
const hikeList = [
  {
    ...
    directions:
      ...
      "Cave Falls road.Drive to the end of the Cave Falls road. There is a parking area at the trailhead.",
  },
  {
    name: "Teton Canyon",
    imgSrc: "falls.jpg",
    ...
    directions:
      ...
      "Follow that road for a few miles then turn right onto Staline Raod " +
      "for a short distance, then left onto Alta Road. Veer right after Alta " +
      "back onto Teton Canyon Road. There is a parking area at the trailhead.",
  },
  {
    name: "Denanda Falls",
    imgSrc: "falls.jpg",
...
function renderOneHikeFull(hike) {
  ...
  item.innerHTML = ` 
        ...
        <div>
          ...
          <textarea rows="10" id="commentText"></textarea>
          <button type="submit" id="newComments">Submit</button>
        </div>
        <div>
          <ul id="comments">
          </ul>
